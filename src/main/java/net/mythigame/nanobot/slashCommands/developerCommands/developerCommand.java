...
public class developerCommand implements SlashCommand {
    @Override
        ...
        switch (subcommand) {
            case "add" -> {
                ...
                try {
                    ...
                    connection.close();
                    event.reply(target.getAsMention() + " a bien été ajouté aux développeurs de NanoBot.").queue();
            ...
            case "remove" -> {
                ...
                try {
                    ...
                    preparedStatement.executeUpdate();
                    event.reply(target2.getAsMention() + " a bien été retiré des développeurs de NanoBot.").queue();
                } catch (Exception e) {
                    e.printStackTrace();
                    event.reply("Une erreur est survenue ! Veuillez contacter un développeur.").queue();
                }
